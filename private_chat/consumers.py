...
class PrivateChatConsumer(AsyncWebsocketConsumer):
    ...
    #         self.group_name,
    #         {"type": "connected_users_count", "connected_users": participants},
    #     )
    ...
    #     print(
    #         "ChatConsumer: connected_user_count: count: ", str(event["connected_users"])
    #     )
    #     data = {
    ...
    #     created_message = ChatRoomMessage.objects.create(
    #         user=user, content=message, room=room
    #     )
